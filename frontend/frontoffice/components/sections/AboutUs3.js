...
export default function AboutUs3() {
	return (
		<>
			...
			<section className="about-us-home5 pt-122 pb-130 bg-1 relative">
						...
						<div className="col-md-6">
							<div className="about-us-h5-content">
								<div className="heading-title">
									...
									<h2 className="title text-white">We Are Professional<br /> Web Design Agency Based On
										<span className="text-blue1 mask">New York</span>
									</h2>
								</div>
