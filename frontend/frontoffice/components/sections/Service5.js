					...
					<div className="row mb-80">
						<div className="col-lg-12">
							<div className="heading-title center m0-auto w-680">
								...
								<h2 className="title wow fadeInUpSmall" data-wow-delay=".3s">We Are Specialist We Offer for
									Grow Your <span className="text-blue1 mask">Business</span></h2>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-lg-12 mb-70">
							<div className="service-item-list">
								<div className="service-item flex-three wow fadeInUpSmall" data-wow-delay=".3s">
									<div className="image">
								...
								<div className="service-item flex-three wow fadeInUpSmall" data-wow-delay=".4s">
									<div className="image">
								...
								<div className="service-item flex-three wow fadeInUpSmall" data-wow-delay=".5s">
									<div className="image">
								...
								<div className="service-item flex-three wow fadeInUpSmall" data-wow-delay=".6s">
									<div className="image">
