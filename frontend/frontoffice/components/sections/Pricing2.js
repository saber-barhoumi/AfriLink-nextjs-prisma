...
export default function Pricing2() {
	...
	return (
		<>
			...
			<section className="pricing-h5 pt-122 pb-130 bg-7">
				<div className="tf-container">
					<div className="row mb-60">
						<div className="col-md-7">
							<div className="heading-title">
								<span className="sub-title text-blue1 font-man wow fadeInUpSmall" data-wow-delay=".2s">Pricing Package</span>
								<h2 className="title wow fadeInUpSmall" data-wow-delay=".3s">Choose Latest <span className="text-blue1 mask">Pricing</span></h2>
							</div>
						</div>
						<div className="col-md-5">
							<p className="des wow fadeInUpSmall" data-wow-delay=".2s">Sed ut perspiciatis unde omniste natus sit voluptatem accus antiume
								doloremque laudantium totam aperiame abillo inventore</p>
							<ul className="nav nav-tabs-pricing " id="myTab" role="tablist">
								...
								<div className={isTab == 1 ? "tab-pane fade show active" : "tab-pane fade"} id="monthly-tab-pane" role="tabpanel" aria-labelledby="monthly-tab" tabIndex={0}>
									<div className="row">
										<div className="col-md-4 wow fadeInUpSmall" data-wow-delay=".2s">
											<div className="tf-pricing style-01">
