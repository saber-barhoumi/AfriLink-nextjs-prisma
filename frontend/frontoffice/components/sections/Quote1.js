					...
					<div className="row quote-style">
						...
						<div className="col-md-8">
							<div className="content">
								<p className="des wow fadeInUpSmall" data-wow-delay=".2s">" Every great dream begins with a dreamer. Always remember, you have
									within you the strength, the patience, and the passion to reach for the stars to
									change the world. "
								</p>
								<div className="flex-three name wow fadeInUpSmall" data-wow-delay=".3s">
									<span>--- Harriet Tubman</span>
									<img src="/assets/images/testimonial/name.png" alt="image" />
								</div>
								<div className="flex-three image-wrap ">
									<ul className="image-list flex-three wow fadeInUpSmall" data-wow-delay=".4s">
										<li>
									...
									<div className="content-image wow fadeInUpSmall" data-wow-delay=".5s">
