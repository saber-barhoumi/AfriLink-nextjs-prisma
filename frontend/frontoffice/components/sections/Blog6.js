				...
				<div className="tf-container">
					<div className="row mb-60">
						<div className="col-md-7">
							<div className="heading-title">
								...
								<h2 className="title text-white wow fadeInUpSmall" data-wow-delay=".2s">Upcoming News <span className="text-blue2 mask">&amp; Blog</span></h2>
							</div>
						</div>
					...
					<div className="row ">
						<div className="col-md-4 wow fadeInUpSmall" data-wow-delay=".2s">
							<div className="tf-blog-style3 blog-style3-dark">
